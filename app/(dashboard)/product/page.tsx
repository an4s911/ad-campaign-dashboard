  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link
          href="/product/new"
          className="flex items-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:opacity-90"
        >
      ...
      {products.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card" role="table" aria-label="Products">
          <div role="row" className="grid grid-cols-[48px_1fr_1.5fr_100px_140px] items-center gap-4 border-b border-border bg-muted/30 px-4 py-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
            <span role="columnheader" aria-label="Image" />
            ...
            >
              ...
              <div className="flex items-center justify-end gap-1" onClick={(e) => e.preventDefault()}>
                ...
                <button
                  ...
                  className="rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-error/10 hover:text-error focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
                  <svg aria-hidden="true" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
