  ...
  return (
    <div>
      ...
      {campaigns.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card" role="table" aria-label="Campaigns">
          <div role="row" className="grid grid-cols-[1.5fr_90px_90px_90px_110px_130px] items-center gap-4 border-b border-border bg-muted/30 px-4 py-3 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
