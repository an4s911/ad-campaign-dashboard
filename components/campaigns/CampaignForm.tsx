    ...
    <div className="mx-auto max-w-5xl animate-fade-in pb-32">
      ...
      <div className="pb-10 pt-2">
        <button
          ...
          className="mb-6 inline-flex items-center gap-1.5 text-sm text-muted-foreground transition-colors duration-150 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
        ...
        <div className="flex items-end justify-between gap-6">
          <div className="min-w-0 flex-1">
            <input
              ...
              className={`w-full bg-transparent text-[2.5rem] font-bold leading-tight tracking-[-0.03em] text-foreground outline-none placeholder:text-muted-foreground/40 ${
                errors.name ? "border-b border-error/50" : ""
              }`}
            />
          ...
          <div className="flex shrink-0 items-center gap-3 pb-1">
            ...
            <button
              ...
              className="rounded-xl border border-border bg-card px-4 py-2 text-sm font-medium text-foreground shadow-[0_1px_2px_rgba(0,0,0,0.04)] transition-all duration-150 hover:bg-muted disabled:cursor-not-allowed disabled:opacity-40"
            >
      ...
      <div className="divide-y divide-border">
        {/* 01 \u2014 Products */}
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[220px_1fr] md:gap-16">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">01</p>
            <h2 className="mt-1 text-sm font-semibold text-foreground">Products <span className="text-error">*</span></h2>
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">Featured items for this campaign.</p>
            <div className="mt-5">
              <label htmlFor="ad-count" className="mb-1 block text-xs font-medium text-muted-foreground">
                Ads to generate
              </label>
              <input
                id="ad-count"
                ...
                className={`w-24 rounded-lg border px-3 py-1.5 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${
          ...
          <div>
            <div className="mb-3 flex items-center justify-between">
              <p className="text-xs text-muted-foreground">{selectedProductIds.length}/{adCount} selected</p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[220px_1fr] md:gap-16">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">02</p>
            <h2 className="mt-1 text-sm font-semibold text-foreground">Audience</h2>
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">Narrow reach by labels, age, and gender. All fields are optional.</p>
          </div>
          <div className="space-y-6">
            <div>
              <p className="mb-2 text-xs font-medium text-muted-foreground">Labels</p>
              <TogglePills options={STORE_CATEGORIES} selected={storeCategories} onChange={setStoreCategories} label="Labels" />
            </div>

            <div className="flex flex-wrap items-start gap-8">
              <div>
                <p className="mb-2 text-xs font-medium text-muted-foreground">Age range</p>
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="w-20 rounded-lg border border-input bg-background px-3 py-1.5 text-sm text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  />
                ...
                <div className="flex gap-2">
                  {GENDER_OPTIONS.map((option) => (
                    <button
                      key={option}
                      type="button"
                      onClick={() => setGender(gender[0] === option ? [] : [option])}
        ...
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[220px_1fr] md:gap-16">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">03</p>
            <h2 className="mt-1 text-sm font-semibold text-foreground">Ad Text <span className="text-error">*</span></h2>
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">Text overlaid on each generated image. One active entry per ad slot.</p>
            <p className="mt-2 text-[11px] text-muted-foreground/60">{activeAdTextCount}/{adCount} active</p>
          </div>
          <div>
            {errors.adTexts && <p className="mb-3 text-xs text-error">{errors.adTexts}</p>}

            {selectedProductIds.length === 0 ? (
              <p className="text-sm text-muted-foreground">Select products first.</p>
            ) : (
              <div className="space-y-4">
                {selectedProductIds.map((productId) => {
                  ...
                  return (
                    <div key={productId} className="rounded-xl border border-border bg-card p-4">
                      ...
                      {!hasActiveTextEntry && (
                        <div className="mb-3 rounded-lg border border-warning/20 bg-warning/10 px-3 py-2 text-xs text-warning">
                          No active entries. This product won&apos;t generate any ads.
                        </div>
                      )}

                      {productEntries.length === 0 ? (
                        <p className="text-xs text-muted-foreground">Click Add to add a text entry.</p>
                      ) : (
                            ...
                            return (
                              ...
                              >
                                <input
                                  ...
                                  autoComplete="off"
                                  className="flex-1 rounded-lg border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                                />
                                {exceedsLimit && (
        ...
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[220px_1fr] md:gap-16">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">04</p>
            <h2 className="mt-1 text-sm font-semibold text-foreground">Visual Style <span className="text-error">*</span></h2>
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">Choose one or more styles. Each style generates its share of ads.</p>
            <p className="mt-2 text-[11px] text-muted-foreground/60">{totalStyleSelections}/{adCount} selected</p>
          </div>
          <div>
            ...
            <div className="mt-8 border-t border-border/50 pt-6">
              <p className="mb-1 text-xs font-medium text-muted-foreground">Or upload a reference image</p>
              <p className="mb-4 text-xs text-muted-foreground/70">One-off references for this campaign only. Count toward the style limit.</p>
                ...
                {uploadedStyleReferences.length > 0 ? (
                  <div className="grid gap-3 sm:grid-cols-2">
                    {uploadedStyleReferences.map((style, index) => (
                      <div
                        key={style.id}
                        className="group relative aspect-[4/3] w-full overflow-hidden rounded-xl border border-border bg-muted"
                      >
                        <button
                          type="button"
                        ...
                        >
                          ...
                          <div className="absolute inset-x-0 bottom-0 p-3 text-left">
                            <p className="text-xs font-semibold text-white">Reference {index + 1}</p>
                          </div>
                        </button>
                        <button
                          type="button"
                  ...
                  <div className="flex min-h-32 items-center justify-center rounded-xl border border-dashed border-border bg-muted/30 px-6 text-center text-xs text-muted-foreground">
                    Uploaded references appear here
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-[220px_1fr] md:gap-16">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground/60">05</p>
            <h2 className="mt-1 text-sm font-semibold text-foreground">Generate</h2>
            <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">Autosave keeps this draft current. Generation runs from the latest saved state.</p>
          </div>
          <div>
            {showGenerateConfirm ? (
              <div className="rounded-xl border border-border bg-card p-5">
                <p className="text-sm font-semibold text-foreground">Confirm generation</p>
                <p className="mt-1 text-xs text-muted-foreground">
                  {adCount} ad{adCount !== 1 ? "s" : ""} across {totalStyleSelections} style{totalStyleSelections !== 1 ? "s" : ""}. Takes around 60 seconds.
                </p>
                <div className="mt-4 flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() => { setShowGenerateConfirm(false); void handleGenerate(); }}
                    disabled={generating || saving}
                    className="rounded-xl bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-[0_1px_2px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.12)] transition-all duration-150 hover:brightness-110 disabled:opacity-40"
                  >
              ...
              <div>
                <button
                  type="button"
                  onClick={() => { if (canGenerate) setShowGenerateConfirm(true); }}
            ...
            {generating && generateTotal > 0 && (
              <div className="mt-4 flex items-center gap-3 rounded-xl border border-primary/20 bg-primary/8 px-4 py-3">
                ...
                <p className="text-sm text-primary">Generating {generateDone}/{generateTotal} images...</p>
              </div>
            )}
